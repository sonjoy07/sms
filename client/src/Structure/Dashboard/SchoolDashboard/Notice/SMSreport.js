                        ...
                        <tbody>
                            ...
                            {totalUsed.map(res => {
                                ...
                                return <tr>
                                    ...
                                    <td>{res.purpose === 1 || res.purpose ===2 ?res.class_name:''}</td>
                                    <td>{res.purpose === 1 || res.purpose ===2 ?res.section_default_name:''}</td>
                                    <td>{res.purpose === 1 || res.purpose ===2 ?res.student_code:res.teacher_code}</td>
