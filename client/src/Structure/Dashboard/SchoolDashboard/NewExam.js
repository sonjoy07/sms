              ...
              exam_info?.map((student) => {
                ...
                return (
                  <tr>
                    ...
                    <td style={{ textAlign: 'center' }}>{moment(student.exam_date).format('Do MMM YYYY')}</td>
                    <td style={{ textAlign: 'center' }}>
                      <button type='button' className="btn mt-1 btn-success mr-3" onClick={() => editRoutine(student)}>
                        Edit
                      </button>
                      <button className="btn mt-1 btn-danger" onClick={() => deleteRoutine(student.id)}>
                        Delete
                      </button></td>
                  </tr>
                )
