...
const AddStudent = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${process.env.REACT_APP_NODE_API}/api/session/all`, {
      headers: {
        authorization: "bearer " + localStorage.getItem("access_token"),
      },
    }).then((response) => {
  ...
  const handleSubmit = () => {
    if (sectionID !== '' && classID !== '' && shiftID !== '' && sessionID !== '') {
      ...
      toast('Please Fill up required Field')
    }
  ...
  const editRoutine = (info) => {
    ...
    setId(info.id)
    setClassID(info.class_id)
    setSectionID(info.section_id)
    setSessionID(info.session_id)
    setShiftID(info.shift_id)
  }
                ...
                <div className='row'>
                  ...
                  <div className='col-sm-3 mx-auto p-2'>
                    <div className="form-group">
                      ...
                      <select className='form-control' value={sessionID} onChange={(e) => setSessionID(e.target.value)}>
                        <option value="">Select Session</option>
                        {sessions.map((sectionJSON) => {
                          return (
                            <option value={sectionJSON.id}>
                              {sectionJSON.session_year}
                            </option>
                          );
                        })}
                      </select>
                  ...
                  <div className='col-sm-3 mx-auto p-2'>
                    <div className="form-group">
                      ...
                      <select className='form-control' value={shiftID} onChange={(e) => setShiftID(e.target.value)}>
                        ...
                        {shifts.map((sectionJSON) => {
                          return (
                            <option value={sectionJSON.id}>
                              {sectionJSON.shift_name}
                            </option>
                          );
                        })}
                      </select>
