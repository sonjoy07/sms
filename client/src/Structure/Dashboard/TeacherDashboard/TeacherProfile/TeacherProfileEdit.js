  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        setInitial(studentData.initial)
        setDesignation(studentData.designation)
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9 text-secondary">
                    <input type="text" onChange={(e) => setInitial(e.target.value)} class="form-control" value={initial} />
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9 text-secondary">
                    <input type="text" onChange={(e) => setDesignation(e.target.value)} class="form-control" value={designation} />
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9 text-secondary">
                    <input type="text" onChange={(e) => setDepartment(e.target.value)} class="form-control" value={department} />
                  </div>
                </div>
                <div class="row">
